---
title: Tera 模板检查与格式化
keywords: tera, rust, zola, djlint, tera 模板检查, tera 模板格式化
description: djLint是一个 Tera 模板的代码检查与格式化工具！使用与构建的配置文件，充分利用djLint来检查并格式化你的模板。
tool: tera
---
...
**[什么是 Tera?](https://keats.github.io/tera/)**

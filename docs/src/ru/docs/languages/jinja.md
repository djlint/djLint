...
Шаблоны MiniJinja полностью совместимы с Jinja2, поэтому используйте этот же профиль `jinja`.

Шаблоны Jinjava от HubSpot тоже в стиле jinja, поэтому используйте этот профиль и для них.

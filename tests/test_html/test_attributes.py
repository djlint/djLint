...
test_data = [
    ...
    pytest.param(
        ...
        (
            '<a href="http://test.test:3000/testtesttesttesttesttesttesttesttesttest"\n'
            '    >Test</a\n'
            '>\n'
        ),
    ...
    pytest.param(
        ...
        (
            ...
            '    title=""\n'
            '    value="something pretty long goes here"\n'
            '    style="width: 100px; cursor: text; border: 1px solid pink"></select>\n'
        ),
    ...
    pytest.param(
        ...
        (
            ...
            '        <div\n'
            '            class="a-bem-block__element a-bem-block__element--with-modifer also-another-block__element"></div>\n'
            "    </div>\n"
            "</div>\n"
        ),
        id="class_bem1",
    ...
    pytest.param(
        ...
        (
            '<my-tag\n'
            '    class="md:foo-bg md:foo-color md:foo--sub-bg md:foo--sub-color xl:foo xl:prefix2 --prefix2--something-else unrelated_class_to_fill_80_chars"></my-tag>\n'
        ),
        id="class_colon",
    ),
    pytest.param(
        ...
        (
            '<my-tag\n'
            '    class="__prefix1__foo __prefix1__bar __prefix2__foo prefix2 prefix2--something --prefix2--something-else"></my-tag>\n'
            '<my-tag\n'
            '    class="--prefix1--foo --prefix1--bar --prefix2--foo prefix2 prefix2__something __prefix2__something_else"></my-tag>\n'
        ),
    ...
    pytest.param(
        ...
        (
            ...
            '    ></div>\n'
            '<div\n'
            '    style="background: linear-gradient(to left, hotpink, hsla(240, 100%, 50%, .05), transparent)"\n'
            '    ></div>\n'
